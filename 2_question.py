...
class Quiz:
	...
	def display_options(self):
		...
		self.opts[val]['text']= options_A[self.q_no]
		self.opts[val+1]['text']= options_B[self.q_no]
		self.opts[val+2]['text']= options_C[self.q_no]
		self.opts[val+3]['text']= options_D[self.q_no]
	...
	def display_question(self):
		...
		q_no = Label(gui, text=question[self.q_no], font=( 'ariel' ,12, 'bold' ))
