...
PLAYER_IMAGE = pygame.image.load("player_new.png")
ENEMY_IMAGE = pygame.image.load("enemy_new.png")

BULLET_IMAGE = pygame.image.load("missile.png")
BULLET_IMAGE = pygame.transform.scale(BULLET_IMAGE, (20, 20))

BULLET_IMAGE_G = pygame.image.load("missile.png")
BULLET_IMAGE_G = pygame.transform.scale(BULLET_IMAGE, (30, 30))

ENEMY_IMAGE = pygame.transform.scale(ENEMY_IMAGE, (40, 30))
PLAYER_IMAGE = pygame.transform.scale(PLAYER_IMAGE, (30, 40))
